// Package utils contains dependency-free helpers shared by the CLI.
package utils
...
// JSONSchemaToGo generates Go API types from an OpenAPI JSON schema. It has
// no dependency on the API client, so it remains usable when generated API
// types are stale or unavailable.
func JSONSchemaToGo(data []byte, sourceURL string) ([]byte, error) {
	...
	sb.WriteString("// Code generated from the Futrou OpenAPI spec. DO NOT EDIT.\n")
	sb.WriteString(fmt.Sprintf("// Generated at: %s\n", time.Now().UTC().Format(time.RFC3339)))
	sb.WriteString("// Source: " + sourceURL + "\n")
	sb.WriteString("\n")
